                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Trang loại bài viết</h4>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        <div class="headerds">
                                            <a href="../admin/typepost/add" class="btn btn-primary waves-effect waves-light"><i class=" ion ion-ios-add-circle-outline font-20"></i></a>
                                        </div>
                                        <h4 class="m-t-0 header-title mb-4"><b>Trang Loại Bài Viết</b></h4>
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <?php
                                                foreach ($TypePost as $key => $value) {
                                                    ...
                                                    echo'
                                                        <td>'.$value["id"].'</td>
                                                        <td>'.$value["type_post_name"].'</td>
                                                        <td>
                                                            <a href="" class="text-primary font-20" style="margin-right: 10px;"><i class="fa fa-wrench"></i></a>
                                                            <span style="border-right: 1px solid gray;"></span>
                                                            <a href="" class="text-danger font-20" onclick="return confirm("Bạn chắc chắn xóa?");" style="margin-left: 10px;"><i class="far fa-trash-alt"></i></a>
                                                        </td>';
                                                    echo '</tr>';
                                                }
                                            ?>
